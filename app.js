/* CMTO Exam Simulator — Application Logic */

const ACCESS_CODE  = "CMTO9000";
const EXAM_SECONDS = 10800;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "cmto_exam_state_v1";
const SIM_Q_COUNT  = 150;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"treatment": "Treatment", "assessment": "Assessment", "professional_practice": "Professional Practice", "clinical_science": "Clinical Science"};  // maps domain key -> human-readable label for display
